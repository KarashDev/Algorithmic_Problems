...
namespace Tests_Sharp
{
    public class Tests
    {
        ...
        public void CamelCase()
        {
            string BreakCamelCase(string str)
            {
                ...
                for (int i = 0; i < inputString.Length; i++)
                {
                    ...
                    {
                        // ≈сли после вставки пробела не сместить i на символ вправо, программа
                        // будет бесконечно вставл€ть пробел перед выбранной буквой
        ...
        // «адача на оптимизацию: установить, €вл€етс€ ли вход€щее число простым. —ложность алгоритма 
        ...
        public void IsNumberPrime()
        {
            bool IsPrime(int n)
            {
                //// ќптимизаци€ є1: увеличиваем шаг перечислени€ в 2 раза, разделив вход на два цикла 
                //// в зависимости от четности/нечетности вход€щего числа
                //if (n <= 0 || n == 1)
                //    return false;
                //else if (n % 2 == 0)
                //{
                ...
                // ќптимизаци€ є2: пересчет ведем не до самого числа, а до корн€ этого числа; так мы
                // сильно уменьшаем число (и количество итераций), но при этом его провер€емые свойства 
                // не мен€ютс€; в догонку можно округлить это число в меньшую сторону, уменьшив его еще 
                // сильнее без потери его провер€емых свойств

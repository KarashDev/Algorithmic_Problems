		...
		static void Main(string[] args)
		{
			...
			int[,] FloodFill(int[,] array, int y, int x, int newValue)
			{
				...
				for (int i = 0; i < height - 1; i++)
				{
					...
					{
						// если по центру - надо чтобы или лево или право или верх или низ был тоже entryNum

						// если первый массив и первое место - надо чтобы или низ или право был тоже entryNum

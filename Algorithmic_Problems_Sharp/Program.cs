...
namespace Algorithmic_Problems_Sharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int GetResult(List<int> chests, int t)
            //{
            //    // Если можно: забрать самое бОльшее, и дальше пытаться забрать то что меньше
            //    // Если нельзя забрать самое бОльшее, постепенно уменьшать и пытаться снова

...
namespace Algorithmic_Problems_Sharp
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			{
				// Если весь подмассив равен 1 или равен 2 - выйграл 1 или 2

				// На всю длину подмассива: если подмассив1[i] == подмассив2[i] И != 0 - выйграл 1 или 2

				// Если подмассив1[i] == подмассив2[i + 1] И подмассив1[i] == подмассив2[i + 2] И != 0
				// -выйграл 1 или 2
